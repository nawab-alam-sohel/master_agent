...
SECRET_KEY = 'django-insecure-94gtcdr8(-8rfb&#8_g*75&1km=1ip2*n^s+%@bo+$-@&i^py4'
...
# ✅ Add this for production static support
...
CSRF_TRUSTED_ORIGINS = ['https://agentsite-project.onrender.com']